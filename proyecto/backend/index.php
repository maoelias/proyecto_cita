...
<body>
    <div class="Caja">
        ...
        <img src="../css/IMG/logotipo.jpeg" alt="Logo" style="width: 300px; height: auto;">
    </div>
            ...
            <button class="btn btn-primary" type="submit" onclick="window.location.href='registrar.php'">Registrarse</button>
        </form>
        <br>
